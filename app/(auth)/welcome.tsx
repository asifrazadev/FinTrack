...
<View style={styles.footer}>
    <Animated.View
    entering={FadeInDown.duration(1000).springify().damping(50)}
     style={{alignItems:"center"}}>
      ...
      <Typo size={30} fontWeight={'800'}>of your Finances</Typo>
        ...
        <Animated.View
         entering={FadeInDown.duration(1000).delay(100).springify().damping(50)}
...
<Animated.View
         entering={FadeInDown.duration(1000).delay(200).springify().damping(50)}
