...
setisLoading(false)
        ...
        <KeyboardAvoidingView>
          ...
          <View style={{ gap: 15, marginTop: spacingY._20 }}>
            ...
            >
             ...
             <Typo size={16} color={colors.textLight}>
              Create account to track all your expanses
            </Typo>
          ...
          <View style={styles.form}>
            ...
            <Button loading={isloading} onPress={HandleSubmit}>
              <Typo size={21} fontWeight={"700"} color={colors.neutral900}>Sign Up</Typo>
            </Button>
          </View>
           </View>
          {/* footer */}
  ...
  <Pressable onPress={handleRoute}>
    <Typo size={15} style={{textDecorationLine:"underline"}} fontWeight={"700"} color={colors.primary}>Log in</Typo>
  </Pressable>
          </View>
        </KeyboardAvoidingView>
      </ScreenWrapper>
